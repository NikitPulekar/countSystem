...
controller.findOneAndUpdate = (model, query, updateObj, incObj = {}) => {
    try {
        return model.findOneAndUpdate(query, { $set: updateObj, $inc: incObj });
    } catch (error) {
        console.log(error);
    }
};

controller.findOneAndInc = (model, query, updateObj) => {
    try {
        return model.findOneAndUpdate(query, updateObj);
    } catch (error) {
        console.log(error);
    }
};
...
controller.updateWithUnset = (model, query, updateQuery) => {
    try {
        return model.findOneAndUpdate(query, updateQuery);
    } catch (error) {
        console.log(error);
    }
};
...
controller.deleteQuery = (model, query) => {
    try {
